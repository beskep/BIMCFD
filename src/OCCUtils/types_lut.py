...
# from OCC.Core.Geom import Handle_Geom_CylindricalSurface
...
_curve_typesB = ('line', 'circle', 'ellipse', 'hyperbola', 'parabola', 'bezier',
                 'spline', 'other')
...
_topoTypesB = [
    ...
    TopAbs_SOLID, TopAbs_COMPSOLID, TopAbs_COMPOUND, TopAbs_SHAPE
]
...
_brep_check_b = [
    ...
    BRepCheck_SelfIntersectingWire, BRepCheck_NoSurface, BRepCheck_InvalidWire,
    BRepCheck_RedundantWire, BRepCheck_IntersectingWires,
    BRepCheck_InvalidImbricationOfWires, BRepCheck_EmptyShell,
    BRepCheck_RedundantFace, BRepCheck_UnorientableShape, BRepCheck_NotClosed,
