...
from OCC.Core.BRepBuilderAPI import (
    ...
    BRepBuilderAPI_MakeEdge2d, BRepBuilderAPI_MakeEdge,
    BRepBuilderAPI_MakeVertex, BRepBuilderAPI_FindPlane)
from OCC.Core.BRepPrimAPI import (BRepPrimAPI_MakeBox, BRepPrimAPI_MakePrism)
from OCC.Core.BRepOffsetAPI import BRepOffsetAPI_MakeEvolved
from OCC.Core.GeomAbs import (GeomAbs_Arc, GeomAbs_C2, GeomAbs_C0,
                              GeomAbs_Tangent, GeomAbs_Intersection, GeomAbs_G1,
                              GeomAbs_G2, GeomAbs_C1)
...
def make_offset_shape(shapeToOffset,
  ...
  try:
    offset = BRepOffsetAPI_MakeOffsetShape(shapeToOffset, offsetDistance,
                                           tolerance, offsetMode, intersection,
                                           selfintersection, joinType)
    if offset.IsDone():
      return offset.Shape()
    else:
      return None
...
def face_from_plane(_geom_plane, lowerLimit=-1000, upperLimit=1000):
  ...
  _trim_plane = make_face(
      Geom_RectangularTrimmedSurface(_geom_plane.GetHandle(), lowerLimit,
