...
from OCC.Core.TColgp import (TColgp_HArray1OfPnt, TColgp_Array1OfPnt,
                             TColgp_Array1OfPnt2d, TColgp_Array1OfVec)
...
def intersect_shape_by_line(topods_shape,
  ...
  with assert_isdone(shape_inter,
    ...
    return (shape_inter.Pnt(1), shape_inter.Face(1), shape_inter.UParameter(1),
            shape_inter.VParameter(1), shape_inter.WParameter(1))
...
def wire_to_curve(wire,
  ...
  approx = Approx_Curve3d(hadap.GetHandle(), tolerance, order, max_segment,
                          max_order)
